...
assert(pkg.name === "git-commit-logically-skill", "package name must be git-commit-logically-skill");
assert(
  pkg.repository?.url === "git+https://github.com/Nick2bad4u/git-commit-logically.git",
...
for (const requiredFile of ["SKILL.md", "LICENSE.txt", "agents/", "assets/", "README.md", "CHANGELOG.md", "SECURITY.md"]) {
